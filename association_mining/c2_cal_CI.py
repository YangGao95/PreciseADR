...
def get_CI_bound(key="gender"):
    ...
    drug_se_matrix, SE_map, drug_map, aim_map = pk.load(open(f"./drug_se_{key}_matrix_only_v3.pk", "rb"))
    filename = f"./se_drug_{key}_matrix_v2.pk"
    ...
    with open(f"se_{key}_matrix_ci_v2.pk", "wb") as f:
